...
import {LeftCurve, RightCurve} from './design/colaboration'
...
<h2 className='h2 mb-4 '> AI Chat App For Seemless Collaboration</h2>
<ul className="max-w-[22rem] mb-10 md:mb-14">
            {collabContent.map((item) => (
              <li className="mb-3 py-3" key={item.id}>
                <div className="flex items-center">
                  <img src={check} width={24} height={24} alt="check" />
                  <h6 className="body-2 ml-5">{item.title}
          ...
          <Button>Try it now</Button>
            ...
            <div className='lg:ml-auto xl:w-[38rem] '>
                <p className='body-2 mb-4 mt-4 text-n-4 md:mb-16 lg:mb-32 lg:w-[22rem] lg:mx-auto'>
                     {collabText}</p>
                     <div className='mt-5 relative left-1/2 flex w-[22rem] aspect-square border border-n-6 rounded-full -translate-x-1/2 scale:75 '>
