...
import { service1 ,service2,service3,check, hero } from '../assets'
...
<div className='relative '>
    ...
    <div className='absolute top-0 left-0 w-full h-full pointer-events-none md:w-3/5 xl:w-auto'>
        <img className='w-full h-full object-cover md:object-right ' width={800} src={service1} alt="Smart AI" />
    </div>
...
<p className='body-2 mb-[3rem] text-n-3'>Automatically enhance your photos using our AI app&appos;s photo editing feature. Try it now!</p>
</div>
<PhotoChatMessage/>
        </div>
...
<div className='py-12 px-4 xl:px-8 '>
    ...
    <p className='body-2 mb-[2rem] text-n-3'>The World Most Power AI Photo And Video Art Genration Engine. What Will You Create?</p>
    <ul className='flex items-center justify-between '>
        {brainwaveServicesIcons.map((item,index)=>(
<li className={` rounded-2xl flex items-center justify-center ${index === 2 ? 'w-[3rem] h-[3rem] p-0.25 bg-conic-gradient rounded-2xl md:w-[4.5rem] md:h-[4.5rem]' : 'flex w-10 h-10 bg-n-6 md:w-15 md:h-15 '} `}>
